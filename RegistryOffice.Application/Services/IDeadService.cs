...
public interface IDeadService
{
    ...
    Task<DeadModel> AddDead(DeadToAddModel dead, string DeathCaseIMG, string connectionString);
    Task<DeadModel> UpdateDead(DeadModel dead, string impPathToDel, string connectionString);
